...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 L'import du catalogue signale une ligne dont le nom ou un code contient un caractere de controle, ou un emoji hors BMP
- [x] #2 Le comportement choisi (erreur de ligne ou nettoyage explicite annonce a l'utilisateur) est teste dans CsvParserTest ou equivalent
<!-- AC:END -->
...
Controle par ValidationEnvoi.problemeTexte, teste dans ImportCatalogueTest. Verification 25/09 : testDebugUnitTest, lintDebug et assembleRelease OK ; connectedDebugAndroidTest 67/67 sur emulateur (127.0.0.1:21503).
<!-- SECTION:NOTES:END -->

## Final Summary

<!-- SECTION:FINAL_SUMMARY:BEGIN -->
Caractere de controle ou emoji hors BMP dans un code ou un nom = erreur de ligne a l'import, comptee dans le seuil de 10 %, jamais nettoyee en silence. Verifie par ImportCatalogueTest.
